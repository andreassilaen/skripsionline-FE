  ...
  const MutasiStock = (props) => {
    ...
    async function mountMutasiStock(pt, outcode, procod, group, startdate, enddate, noref, type, params) {
      try {
        ...
        const getMutasiStock = await api.getMutasiBookStockProcod(pt, outcode, procod, group, startdate, enddate, noref, type, params);
      ...
      <Box sx={{ width: "100%", p: 3 }}>
        ...
        <Grid item xs={4} sm={4} md={4} lg={4}>
            ...
            <Typography variant="h5" sx={{ fontWeight: 600, mt: 0.5 }}>
                {language === 'EN' ? 'Inventory Book Stock Turnover' : 'Mutasi Book Stock'}
            </Typography>
            </Grid>
              ...
              (
                ...
                result.length !== 0 ? 
                  ...
                  <TableRow key={item.stck_batchnumber}>
                    ...
                    {/* <TableCell align="center">{buttonPrint(item)}</TableCell> 31/01/23*/}
                  </TableRow>
                ))) : (
                  <TableRow>
                    <TableCell align="center" colSpan={12}>
